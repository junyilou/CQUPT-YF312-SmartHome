...
final class MQTTManager: ObservableObject {
    ...
    func initializeMQTT(host: String, identifier: String, username: String? = nil, password: String? = nil, house: House? = nil) {
...
extension MQTTManager: CocoaMQTTDelegate {
    ...
    func mqtt(_ mqtt: CocoaMQTT, didReceiveMessage message: CocoaMQTTMessage, id: UInt16) {
        ...
        if house != nil {
            house.getRemoteInfo(message.string.description)
        }
    }
